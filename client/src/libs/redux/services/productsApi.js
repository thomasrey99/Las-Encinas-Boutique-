...
export const productsApi=createApi({
    ...
    endpoints:(builder)=>({
        getAllProducts:builder.query({
            query:({name, minPrice, maxPrice, category, order, type, is_Delete}) => `/products?name=${name}&minPrice=${minPrice}&maxPrice=${maxPrice}&category=${category}&type=${type}&order=${order}&is_Delete=${!is_Delete?"":is_Delete}`,
